...
public class SmarthomeWsImpl implements SmarthomeWs {
	...
	@Override
	public String addCentralAir(String masterCode, int electricIndex, String airCode,String airName) {
		int re = smarthomeService.addCentralAir(masterCode, electricIndex, airCode,airName);
		AppWebSocket.sendSync(masterCode);
		return String.valueOf(re);
	}
	
	@Override
	public String deleteCentralAir(String masterCode, int electricIndex, String airCode,String airName) {
		int re = smarthomeService.deleteCentralAir(masterCode, electricIndex, airCode,airName);
		AppWebSocket.sendSync(masterCode);
		return String.valueOf(re);
	}
